...
class Mittausluokka:
    def __init__(self, kaasunimi, gageid = "99", kaasuid = "99", muutos_raja_arvo = sys.float_info.max, pakotettu_tallennusvali = sys.float_info.max):
        ...
        self.muutos_raja_arvo = muutos_raja_arvo
        self.pakotettu_tallennusvali = pakotettu_tallennusvali
        self.talletettuarvo = 0
        self.talletus_aika = 0
    ...
    def talleta_edellinenmitta(self):
        print("edellinen " + self.kaasunimi + " kantaan ")
        # kaikenvaralta false :-) 
        self.edellinen_tallentamatta = False
